                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('adminPanel.store.slider') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($AllSlide as $item)
                                            <tr>
                                                <td> {{ $i++ }} </td>
                                                <td> <img src="{{asset('storage/'.$item->home_slide)}}"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('adminPanel.delete.slide', $item->id) }}"
