        ...
        <form id="form-raspa-gana" action="{{ route($tipoJuego."juego2.post.registro.personalizar", $project->id) }}" method="POST" enctype="multipart/form-data" class="col-2 border-end" style="overflow-y: scroll; height: 100vh;">
            ...
            <div class="d-none" id="pagina_principal">
                ...
                <div class="py-2 border-bottom">
                    ...
                    <ul class="list-unstyled ps-4 collapse" id="collapseTwoGame" data-bs-parent="#collapseTwoGame">
                        <li class="my-2">
            ...
            <div class="d-none" id="encabezado">
                ...
                <div class="py-2 border-bottom">
                    ...
                    <ul class="list-unstyled ps-4 mt-2 collapse" id="collapseTwoPremio" data-bs-parent="#accordionExample">
                        <li>
                ...
                <div class="py-2 border-bottom">
                    <button class="header-edit-web" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThreePremio" aria-expanded="true" aria-controls="collapseThreePremio">
                        <p class="mb-0"><b><img src="{{asset('backend/svg/cuadro-titulo.svg')}}" alt="svg seccion"> <small>Bloque Premiación</small></b></p>
                    </button>

                    <ul class="list-unstyled ps-4 mt-2 collapse" id="collapseThreePremio" data-bs-parent="#accordionExample">
            ...
            <div id="juego_casino_raspa" style="background-image: url('{{ $fondo }}'); background-size: cover; height: 100vh; position: relative;">
                <div id="card-raspa">
                    <div class="text-header">
                        ...
                        <img id="logo_casino" src="{{ $logo_principal }}" alt="">
                    </div>
                    <div class="container">
                        <div class="base">
                ...
                <div id="card-premio" class="d-none">
                    <div class="d-flex justify-content-center pt-4 w-100 pb-4">
                        <img class="img-fluid" src="{{ $titulo_subir }}" alt="" id="img-header-premio">
                    </div>
