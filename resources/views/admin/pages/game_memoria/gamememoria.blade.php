            ...
            <div class="d-block w-100">
                ...
                <div class="container h-100 d-flex align-items-center d-none" id="poltica-privacidad">
                    <div class="content_politicas_terminos text-center p-5">
                        ...
                        <div class="d-flex justify-content-between mt-5 botonera-terminos">
                            <button type="button" class="btn_politicas text-uppercase" id="aceptar_politica" style=" background-color: {{ $colorPolitica }} !important;">ACEPTAR Y CONTINUAR</button>
                ...
                <div class="container h-100 d-flex align-items-center d-none" id="terminos-condiciones">
                    <div class="content_politicas_terminos text-center p-5">
                        ...
                        <div class="d-flex justify-content-between mt-5 botonera-terminos">
                            <button type="submit" class="btn_politicas text-uppercase" id="aceptar_terminos" style=" background-color: {{ $colorTermino }} !important;">ACEPTAR Y CONTINUAR</button>
