        ...
        <div class="container h-100-vh">
            ...
            <div class="container h-100 d-flex align-items-center d-none" id="poltica-privacidad">
                <div class="content_politicas_terminos text-center p-5">
                    <h1 class="w-75 m-auto" style="color: {{ $colorPolitica }} !important;border-color: {{ $colorPolitica }} !important;">POLÍTICA DE PRIVACIDAD</h1>
                    <p class="mt-4" style="color: {{ $colorPolitica }} !important;">
                        @php
                            echo $politicas;
                        @endphp
                    </p>
            ...
            <div class="container h-100 d-flex align-items-center d-none" id="terminos-condiciones">
                <div class="content_politicas_terminos text-center p-5">
                    <h1 class="w-75 m-auto" style="color: {{ $colorTermino }} !important;border-color: {{ $colorTermino }} !important;">TÉRMINOS Y CONDICIONES</h1>
                    <p class="mt-4" style="color: {{ $colorTermino }} !important;">
                        @php
                            echo $terminos;
                        @endphp
                    </p>
                    <div class="d-flex justify-content-between mt-5">
                        <button type="submit" class="btn_politicas text-uppercase" id="aceptar_terminos" style=" background-color: {{ $colorTermino }} !important;">Aceptar y contnuar</button>
                        <a href="{{ route('index') }}" class="btn_politicas text-uppercase" style="text-decoration: none; background-color: {{ $colorTermino }} !important;">No Aceptar y salir</a>
                    </div>
                </div>
            </div>
        </div>
